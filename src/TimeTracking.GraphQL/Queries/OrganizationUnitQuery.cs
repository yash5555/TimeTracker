...
using TimeTracking.Core.Extensions;
using TimeTracking.Dto;
using TimeTracking.Types;

namespace TimeTracking.Queries
{
    public class OrganizationUnitQuery : TimeTrackingQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
