...
using TimeTracking.Authorization.Ldap;
...
using TimeTracking.DynamicEntityProperties;
...
using TimeTracking.WebHooks;
using Newtonsoft.Json;

namespace TimeTracking
{
    [DependsOn(
        typeof(TimeTrackingCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class TimeTrackingCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            TimeTrackingLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = TimeTrackingConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, TimeTrackingMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<TimeTrackingSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TimeTrackingCoreModule).GetAssembly());
        }
