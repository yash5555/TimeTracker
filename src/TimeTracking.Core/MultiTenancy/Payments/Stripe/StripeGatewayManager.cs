...
{
    public class StripeGatewayManager : TimeTrackingServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "TimeTracking";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + TimeTrackingConsts.Currency;
        }
