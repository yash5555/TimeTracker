...
namespace TimeTracking.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : TimeTrackingServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("TimeTracking", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
