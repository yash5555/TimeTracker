...
namespace TimeTracking.Web.Public.Startup
{
    [DependsOn(
        typeof(TimeTrackingWebCoreModule)
    )]
    public class TimeTrackingWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public TimeTrackingWebFrontEndModule(IWebHostEnvironment env, TimeTrackingEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TimeTrackingWebFrontEndModule).GetAssembly());
        }
    }
}
