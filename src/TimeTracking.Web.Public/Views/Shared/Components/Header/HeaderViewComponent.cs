...
using TimeTracking.Web.Public.Startup;
using TimeTracking.Web.Session;

namespace TimeTracking.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : TimeTrackingViewComponent
    {
