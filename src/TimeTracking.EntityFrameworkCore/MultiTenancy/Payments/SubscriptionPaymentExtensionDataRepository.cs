...
{
    public class SubscriptionPaymentExtensionDataRepository : TimeTrackingRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<TimeTrackingDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
