...
using TimeTracking.EntityFrameworkCore.Repositories;

namespace TimeTracking.MultiTenancy.Payments
{
    public class SubscriptionPaymentRepository : TimeTrackingRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<TimeTrackingDbContext> dbContextProvider)
