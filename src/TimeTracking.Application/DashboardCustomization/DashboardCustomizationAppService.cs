...
using TimeTracking.DashboardCustomization.Definitions;
using TimeTracking.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace TimeTracking.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : TimeTrackingAppServiceBase, IDashboardCustomizationAppService
    {
