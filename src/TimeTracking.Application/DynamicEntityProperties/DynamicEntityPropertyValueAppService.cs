...
using TimeTracking.DynamicEntityPropertyValues.Dto;

namespace TimeTracking.DynamicEntityProperties
{
    [AbpAuthorize(AppPermissions.Pages_Administration_DynamicEntityPropertyValue)]
    public class DynamicEntityPropertyValueAppService : TimeTrackingAppServiceBase, IDynamicEntityPropertyValueAppService
    {
