...
using TimeTracking.Configuration.Host.Dto;
using TimeTracking.EntityFrameworkCore;
using TimeTracking.Identity;
using TimeTracking.Install.Dto;
using TimeTracking.Migrations.Seed;
using TimeTracking.Migrations.Seed.Host;
...
namespace TimeTracking.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : TimeTrackingAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<TimeTrackingDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{TimeTrackingConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{TimeTrackingConsts.ConnectionStringName}", constring);
        }
