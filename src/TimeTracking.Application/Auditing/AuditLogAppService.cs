...
using TimeTracking.Auditing.Exporting;
using TimeTracking.Authorization;
using TimeTracking.Authorization.Users;
using TimeTracking.Dto;
using TimeTracking.EntityHistory;
using EntityHistoryHelper = TimeTracking.EntityHistory.EntityHistoryHelper;

namespace TimeTracking.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : TimeTrackingAppServiceBase, IAuditLogAppService
    {
