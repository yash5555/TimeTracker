...
using TimeTracking.Authorization.Users.Profile.Cache;
using TimeTracking.Authorization.Users.Profile.Dto;
using TimeTracking.Configuration;
using TimeTracking.Friendships;
using TimeTracking.Gdpr;
using TimeTracking.Net.Sms;
using TimeTracking.Security;
using TimeTracking.Storage;
using TimeTracking.Timing;

namespace TimeTracking.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : TimeTrackingAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("TimeTracking",
