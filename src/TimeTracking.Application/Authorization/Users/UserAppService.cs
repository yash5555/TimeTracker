...
using TimeTracking.Authorization.Permissions;
...
using TimeTracking.Authorization.Users.Exporting;
...
namespace TimeTracking.Authorization.Users
{
    ...
    public class UserAppService : TimeTrackingAppServiceBase, IUserAppService
    {
