        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = TimeTrackingConsts.Currency,
                    CurrencySign = TimeTrackingConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = TimeTrackingConsts.AllowTenantsToChangeEmailSettings,
