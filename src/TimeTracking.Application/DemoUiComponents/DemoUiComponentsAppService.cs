...
using TimeTracking.DemoUiComponents.Dto;

namespace TimeTracking.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : TimeTrackingAppServiceBase, IDemoUiComponentsAppService
    {
