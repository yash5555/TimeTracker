...
namespace TimeTracking.Web.Authentication.JwtBearer
{
    public class TimeTrackingJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public TimeTrackingJwtSecurityTokenHandler()
        {
