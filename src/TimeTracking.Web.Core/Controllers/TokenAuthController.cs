...
using TimeTracking.Authentication.TwoFactor.Google;
...
using TimeTracking.Web.Models.TokenAuth;
using TimeTracking.Authorization.Impersonation;
using TimeTracking.Authorization.Roles;
using TimeTracking.Configuration;
using TimeTracking.Identity;
using TimeTracking.Net.Sms;
using TimeTracking.Notifications;
using TimeTracking.Security.Recaptcha;
using TimeTracking.Web.Authentication.External;
using TimeTracking.Web.Common;
using TimeTracking.Authorization.Delegation;

namespace TimeTracking.Web.Controllers
{
    [Route("api/[controller]/[action]")]
    public class TokenAuthController : TimeTrackingControllerBase
    {
