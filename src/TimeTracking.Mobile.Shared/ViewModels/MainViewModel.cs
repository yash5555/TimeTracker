...
using TimeTracking.Core.Threading;
using TimeTracking.Models.NavigationMenu;
using TimeTracking.Services.Navigation;
...
using TimeTracking.Localization;
using TimeTracking.UI;
using TimeTracking.UI.Assets;
using TimeTracking.Views;
using DependencyResolver = TimeTracking.Core.Dependency.DependencyResolver;
...
namespace TimeTracking.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "TimeTracking";
