...
using TimeTracking.Web.Startup.ExternalLoginInfoProviders;
...
namespace TimeTracking.Web.Startup
{
    ...
    public class TimeTrackingWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public TimeTrackingWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TimeTrackingWebHostModule).GetAssembly());
        }
