...
using TimeTracking.Authorization.Accounts;
...
using TimeTracking.Web.Models.Ui;
using TimeTracking.Web.Session;

namespace TimeTracking.Web.Controllers
{
    public class UiController : TimeTrackingControllerBase
    {
