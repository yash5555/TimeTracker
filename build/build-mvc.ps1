...
$webMvcFolder = Join-Path $slnFolder "src/TimeTracking.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/TimeTracking.Web.Public"
...
dotnet restore TimeTracking.Web.sln
