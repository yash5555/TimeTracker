...
using TimeTracking.MultiTenancy.HostDashboard;
...
namespace TimeTracking.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(TimeTrackingDbContext context, SubscriptionPayment subscriptionPayment)
        {
